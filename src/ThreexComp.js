import { ArToolkitContext, ArToolkitProfile, ArToolkitSource } from '@ar-js-org/ar.js/three.js/build/ar-threex.js';
    ...
    componentDidMount() {
		...
		model.traverse ( ( o ) => {
			if ( o.isMesh ) {
				...
				const name= o.material.metalnessMap?.name
				if(name) {
					o.material = new THREE.MeshBasicMaterial({map: textureLoader.load(`../cisco/${name}`)});
				}
